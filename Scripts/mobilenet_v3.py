...
Original file is located at
    https://colab.research.google.com/drive/1cOUu4foH8TybSaRgVGC00Tj0g8mp-cf_
"""
...
class CNNOnly(nn.Module):
    def __init__(self, num_classes):
        ...
        with torch.no_grad():
            ...
            print(f"[INFO] CNN feature dimension: {feat_dim}")
...
plt.title("MobilenetV3 Confusion Matrix (Test)")
...
plt.savefig("MobilenetV3_loss.png")
...
plt.savefig("MobilenetV3_acc.png")
...
plt.legend()
plt.savefig("macro_roc_curve.png")
...
precision_macro_curve /= len(class_names)
...
plt.legend()
plt.savefig("macro_pr_curve.png")
...
plt.title("t-SNE Visualization of MobilenetV3 Features (Global Avg Pooled)")
plt.savefig("MobilenetV3_visualization.png")
plt.show()