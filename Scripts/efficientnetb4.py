...
Original file is located at
    https://colab.research.google.com/drive/1koV-k8_kPz9EmdoJRX5aFi-V9yjKCSmK
"""
...
plt.title("EfficientNet-B3 Confusion Matrix (Test)")
plt.savefig("EfficientNet-B3_confusion_matrix.png")

plt.figure()
plt.plot(train_loss_hist, label="Train Loss")
plt.plot(val_loss_hist, label="Val Loss")
plt.legend()
plt.title("EfficientNet-B3 Loss")
plt.savefig("EfficientNet-B3_loss.png")

plt.figure()
plt.plot(train_acc_hist, label="Train Acc")
plt.plot(val_acc_hist, label="Val Acc")
plt.legend()
plt.title("EfficientNet-B3 Accuracy")
plt.savefig("EfficientNet-B3_acc.png")
...
plt.title("t-SNE Visualization of EfficientNet-B3 Features (Global Avg Pooled)")
plt.savefig("EfficientNet-B3_tsne_visualization.png")
plt.show()